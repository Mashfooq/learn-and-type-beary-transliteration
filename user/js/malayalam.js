...
function setupMalayalamMaps() {
  ...
  malayalamKaagunita.set("e", "\u0940"); // u0D46
  malayalamKaagunita.set("E", "\u0949"); // u0D47
  malayalamKaagunita.set("!", "\u0D48"); // ai  
  malayalamKaagunita.set("o", "\u094A"); // u0D4A
  malayalamKaagunita.set("O", "\u094B"); // u0D4B
